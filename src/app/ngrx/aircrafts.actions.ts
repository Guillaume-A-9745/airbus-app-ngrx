...
export enum AircraftActionsTypes {
    ...
    ADD_OPERATION = "[Aircrafts] Add something to Aircrafts",
    REMOVE_OPERATION = "[Aircrafts] Remove something to Aircrafts"
}
